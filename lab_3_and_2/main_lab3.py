...
kiyv_map = Graph(11)
kiyv_map.add_edge(u=0, v=6, distance=5.0,   flow=400, one_way=True)
kiyv_map.add_edge(u=0, v=7, distance=1.0,   flow=400, one_way=True)
kiyv_map.add_edge(u=0, v=9, distance=2.5,   flow=400, one_way=True)
kiyv_map.add_edge(u=1, v=2, distance=0.6,   flow=400, one_way=True)
kiyv_map.add_edge(u=1, v=3, distance=1.3,   flow=400, one_way=True)
kiyv_map.add_edge(u=1, v=7, distance=2.0,   flow=400, one_way=True)
kiyv_map.add_edge(u=1, v=8, distance=0.95,  flow=400, one_way=True)
kiyv_map.add_edge(u=1, v=10, distance=0.6,  flow=400, one_way=True)
kiyv_map.add_edge(u=2, v=0, distance=1.7,   flow=400, one_way=True)
kiyv_map.add_edge(u=2, v=3, distance=1.0,   flow=400, one_way=True)
kiyv_map.add_edge(u=3, v=0, distance=0.9,   flow=400, one_way=True)
kiyv_map.add_edge(u=3, v=1, distance=1.3,   flow=400, one_way=True)
kiyv_map.add_edge(u=3, v=7, distance=1.0,   flow=400, one_way=True)
kiyv_map.add_edge(u=3, v=3, distance=0.55,  flow=400, one_way=True)
kiyv_map.add_edge(u=4, v=2, distance=0.5,   flow=400, one_way=True)
kiyv_map.add_edge(u=4, v=7, distance=1.1,   flow=400, one_way=True)
kiyv_map.add_edge(u=5, v=5, distance=0.75,  flow=400, one_way=True)
kiyv_map.add_edge(u=6, v=0, distance=5.0,   flow=400, one_way=True)
kiyv_map.add_edge(u=7, v=0, distance=1.0,   flow=400, one_way=True)
kiyv_map.add_edge(u=7, v=1, distance=2.0,   flow=400, one_way=True)
kiyv_map.add_edge(u=7, v=4, distance=1.1,   flow=400, one_way=True)
kiyv_map.add_edge(u=7, v=8, distance=1.1,   flow=400, one_way=True)
kiyv_map.add_edge(u=8, v=4, distance=0.75,  flow=400, one_way=True)
kiyv_map.add_edge(u=9, v=0, distance=2.3,   flow=400, one_way=True)
kiyv_map.add_edge(u=9, v=5, distance=0.75,  flow=400, one_way=True)
kiyv_map.add_edge(u=10, v=1, distance=0.6,  flow=400, one_way=True)
kiyv_map.add_edge(u=10, v=5, distance=0.8,  flow=400, one_way=True)
